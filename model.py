...
dataset = pd.read_csv(r'C:\Users\I506660\Documents\GitHub\flask-salary-predictor\Salary_Data.csv')
...
pickle.dump(regressor, open(r'C:\Users\I506660\Documents\GitHub\flask-salary-predictor\model.pkl','wb'))
'''
